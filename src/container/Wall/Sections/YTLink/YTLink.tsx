import styles from "./YTLink.module.scss";
            ...
            <div className={styles.listScroller}>
              {isDataAvailable.map((portfolio, index: number) => (
                ...
                >
                  <div className={styles.videoContainer}>
                    <YoutubeVideoPlayer
                      videoId={extractVideoIdFromUrl(
                        portfolio?.customLink?.link as string
                      )}
                      thumbnailUrl={portfolio?.customLink?.image || ""}
                    />
                  ...
                  <a
                    href={
                      (portfolio?.customLink?.ctaButton?.link as string) || ""
                    }
...
export default transition(YTLink);
